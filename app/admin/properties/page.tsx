    ...
    return (
        <div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1 md:mb-2">Properties</h1>
                    <p className="text-sm md:text-base text-gray-600">Manage your property listings</p>
                </div>
                <Link
                    href="/admin/properties/new"
                    className="w-full sm:w-auto text-center bg-[var(--primary)] text-black px-6 py-3 rounded-lg font-bold hover:bg-black hover:text-white transition-colors shadow-sm"
                >
                    + Add Property
                </Link>
            </div>
                                ...
                                <tr key={property.id} className="hover:bg-gray-50">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            <img src={property.image} alt={property.title} className="w-12 h-12 md:w-16 md:h-16 object-cover rounded-lg flex-shrink-0" />
                                            <div className="min-w-0">
                                                <div className="font-bold text-gray-900 truncate max-w-[200px]">{property.title}</div>
                                    ...
                                    <td className="px-6 py-4 text-sm font-bold text-gray-900">{property.price}</td>
                                    <td className="px-6 py-4">
                                        <span className="px-3 py-1 bg-blue-100 text-blue-800 text-[10px] font-bold rounded-full uppercase">
                                            {property.type}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4 text-sm text-gray-600">{property.views || 0}</td>
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex justify-end gap-2">
                                            ...
                                            <button
                                                ...
                                                className="p-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors text-xs font-bold"
                                                title="Delete"
                                            >
                                                🗑️
                                            </button>
