...
export function middleware(request: NextRequest) {
    ...
    const cspDirectives = [
        ...
        "frame-src 'self' https://widget.cloudinary.com https://upload-widget.cloudinary.com https://www.google.com https://www.youtube.com https://www.youtube-nocookie.com https://www.instagram.com https://*.youtube.com https://*.youtu.be https://*.instagram.com",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'",
